...
app.post('/uploaddp', async function(req, res){
    try
    {
        ...
        myfile.mv('../src/images/photos/'+ fname +'.jpg', function(err){
            if(err)
...
app.post('/sendemail', async function(req, res){
    try
    {
        var transport = nodemailer.createTransport({
            ...
            port: 445,
            secure: true,
            auth:{user: "kuntagnanapujitha@gmail.com", pass: "pepkgqmcizqveflo"}
        });

        var emaildata = {
            from: "kuntagnanapujitha2222@gmail.com",
            to: "nandini.aragala999@gmail.com",
